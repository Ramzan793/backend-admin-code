        ...
        <div class="col-lg-11">
          <div class="detail-box">
            ...
            <form class="text-center" action="code.php" method="POST" enctype="multipart/form-data">
              <label>Title</label> <input class="w-75" type="text" name="bn_title" id=""><br>
              <label>Description</label> <input class="w-75" type="text" name="bn_desc" id="">
              ...
              <label>Btn Txt</label> <input class="w-75" type="text" name="btn_text" id=""><br>
