      ...
      <div class="row justify-content-center">
        <div class="col-lg-11 bg-breadcr">
          <div class="breadcrumb-sec">
              <p><i class="fa fa-file me-2"></i>Website Pages <i class="fa fa-angle-right "></i>Add New Page</p>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-11">
          <div class="detail-box">
            ...
            <form class="text-center" action="code.php" method="POST" enctype="multipart/form-data">
              ...
              <!-- </select> -->
              <label>Name</label> <input class="w-75" type="text" name="pg_name" id=""><br>
              <label>Sort-Order</label> <input class="w-75" type="number" name="sort" id="">
              <label>Heading</label> <input class="w-75" type="text" name="pg_heading" id="">
              <label>Image</label>
              ...
              <label>Short content</label> <input class="w-75" type="text" name="pg_shortcontent" id="">
    
    <label class="maincontent">Main Content</label> <textarea class="w-75 " rows="5" type="text" name="pg_maincontent" id=""></textarea><br>
              <input type="submit" class="submit-btn" value="Submit"> <a href="cms.php" class="cancel-btn">Cancel</a>
            </form>
          </div>
        </div>
      </div>
