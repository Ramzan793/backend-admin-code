      ...
      <div class="row justify-content-center">
        <div class="col-lg-11 bg-breadcr">
          <div class="breadcrumb-sec">
              <p><i class="fa fa-file me-2"></i>CMS (Pages)</p>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-11">
          <a href="cms-detail.php" class="btn btn-success fs-6 float-end rounded-0 my-2"><i class="fa fa-plus me-2"></i>Add New</a>
          <table class="table table-success table-hover table-bordered table-striped-column">
            ...
            <tbody>
              <?php
                ...
                <td><a href="#" class="text-decoration-none bg-success text-white border pt-1 ps-1 pb-1 pe-2"><i class="fa fa-check me-1"></i>Yes</a></td>
                <td>
                <a href="cms-edit.php?user_id=<?php echo $rows ['id'];?>" class="text-decoration-none text-white bg-primary px-2 py-1"><i class="fa fa-edit me-2"></i>Edit</a>
