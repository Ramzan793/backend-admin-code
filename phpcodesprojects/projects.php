      ...
      <div class="row justify-content-center">
        <div class="col-lg-11 bg-breadcr">
          <div class="breadcrumb-sec">
              <p><i class="fa fa-folder me-2"></i>Projects</p>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-11">
          <a href="projects-detail.php" class="btn btn-success fs-6 float-end rounded-0 my-2"><i class="fa fa-plus me-2"></i>Add New</a>
          <table class="table table-success table-hover table-bordered table-striped-column">
            ...
            <tbody>
              <?php
                ...
                <!-- this is for category name from the other table -->
                <td><?php  
                  echo $rows ['category']
                ?></td>
                <!-- category name getting from other table ends here -->
                <td><a href="#" class="text-decoration-none bg-success text-white border p-1"><i class="fa fa-check me-1"></i>Active</a></td>
                <td>
                <a href="projects-edit.php?user_id=<?php echo $rows ['id'];?>" class="text-decoration-none text-white bg-primary px-2 py-1"><i class="fa fa-edit me-2"></i>Edit</a>
