...
<head>
  ...
  <title>Projects Category Add</title>
  <!-- css -->
      ...
      <div class="row justify-content-center">
        <div class="col-lg-11 bg-breadcr">
          <div class="breadcrumb-sec">
              <p><i class="fa fa-folder-o me-2"></i>Projects Category <i class="fa fa-angle-right "></i> Add</p>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-11">
          <div class="detail-box">
            ...
            <form class="text-center" action="codecategory.php" method="POST" enctype="multipart/form-data">
              <label>Name</label> <input class="w-75" type="text" name="projcatname" id=""><br>
