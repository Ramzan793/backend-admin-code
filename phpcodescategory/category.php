      ...
      <div class="row justify-content-center">
        <div class="col-lg-11 bg-breadcr">
          <div class="breadcrumb-sec">
              <p><i class="fa fa-folder me-2"></i>Projects Category</p>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-11">
          <a href="category-detail.php" class="btn btn-success fs-6 float-end rounded-0 my-2"><i class="fa fa-plus me-2"></i>Add New</a>
                ...
                if ($result -> num_rows > 0) {
                    while ($rows = $result -> fetch_assoc()) {
                        ...
                        ?>
                            <tr>
                <th scope="row">#</th>
                <td><?php  echo $rows ['projectcategory']?></td>
                <!-- <td><a href="#" class="text-decoration-none bg-success text-white border pt-1 ps-1 pb-1 pe-2"><i class="fa fa-check me-1"></i>Yes</a></td> -->
                <!-- <td><a href="#" class="text-decoration-none bg-success text-white border p-1"><i class="fa fa-check me-1"></i>Active</a></td> -->
                <td>
                <a href="category-edit.php?user_id=<?php echo $rows ['id'];?>" class="text-decoration-none text-white bg-primary px-2 py-1"><i class="fa fa-edit me-2"></i>Edit</a>
